...
function generateExternalURL(url) {
  ...
  finalURL = finalURL.replace(/{MM}/g, month < 10 ? '0' + month : month.toString());
  finalURL = finalURL.replace(/{M\*}@en/g, MONTHS.en[now.getMonth()].toUpperCase());
  finalURL = finalURL.replace(/{m\*}@en/g, MONTHS.en[now.getMonth()].toLowerCase());
  finalURL = finalURL.replace(/{MMM}@en/g, MONTHS.en[now.getMonth()].substring(0,3).toUpperCase());
  finalURL = finalURL.replace(/{mmm}@en/g, MONTHS.en[now.getMonth()].substring(0,3).toLowerCase());
  finalURL = finalURL.replace(/{M\*}@es/g, MONTHS.es[now.getMonth()].toUpperCase());
  finalURL = finalURL.replace(/{m\*}@es/g, MONTHS.es[now.getMonth()].toLowerCase());
  finalURL = finalURL.replace(/{MMM}@es/g, MONTHS.es[now.getMonth()].substring(0,3).toUpperCase());
  finalURL = finalURL.replace(/{mmm}@es/g, MONTHS.es[now.getMonth()].substring(0,3).toLowerCase());
  var date = now.getDate();
  finalURL = finalURL.replace(/{DD}/g, date < 10 ? '0' + date : date.toString());
  finalURL = finalURL.replace(/{DD-1}/g, date < 10 ? '0' + (date - 1) : (date - 1).toString());
  finalURL = finalURL.replace(/{D\*}@en/g, DAYS.en[now.getDay()].toUpperCase());
  finalURL = finalURL.replace(/{D\*}@en/g, DAYS.en[now.getDay()].toLowerCase());
  finalURL = finalURL.replace(/{DDD}@en/g, DAYS.en[now.getDay()].substring(0, 3).toUpperCase());
  finalURL = finalURL.replace(/{ddd}@en/g, DAYS.en[now.getDay()].substring(0, 3).toLowerCase());
  finalURL = finalURL.replace(/{D\*}@es/g, DAYS.es[now.getDay()].toUpperCase());
  finalURL = finalURL.replace(/{D\*}@es/g, DAYS.es[now.getDay()].toLowerCase());
  finalURL = finalURL.replace(/{DDD}@es/g, DAYS.es[now.getDay()].substring(0, 3).toUpperCase());
  finalURL = finalURL.replace(/{ddd}@es/g, DAYS.es[now.getDay()].substring(0, 3).toLowerCase());
  var hours = now.getHours();
  finalURL = finalURL.replace(/{hh}/g, hours < 10 ? '0' + hours : hours.toString());
  var minutes = now.getMinutes();
  finalURL = finalURL.replace(/{mm}/g, minutes < 10 ? '0' + minutes : minutes.toString());
  var seconds = now.getSeconds();
  finalURL = finalURL.replace(/{ss}/gi, seconds < 10 ? '0' + seconds : seconds.toString());
  return finalURL;
}
